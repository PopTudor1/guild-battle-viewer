...
const A4Row8: GateModel[] = [
  {
    ...
    runesList: [
      ...
      { rune: RuneTypeEnum.S, chance: 7.4, imageUrl: SRune },
      { rune: RuneTypeEnum.SR, chance: 1.8, imageUrl: SRRune },
    ],
  },
  {
    rowPosition: 2,
  ...
  },
  {
    ...
    level: 12,
    element: undefined,
    guildPoints: { imageUrl: GuildPointsImg, points: 865 },
    runesList: undefined,
  },
  {
    rowPosition: 7,
...
export const a4Row8RuneInput: unknown[][] = [
  [
